...
def _call_llm_split(paragraphs: List[str],
    ...
    system_prompt = (
        ...
        f"- MỤC TIÊU: khoảng 15-20 cảnh cho cả chương (ưu tiên GỘP các đoạn cùng "
        f"bối cảnh để mỗi cảnh dài và giàu chi tiết hơn — tối ưu cho mô hình vẽ ảnh yếu)\n"
        f"- Mỗi cảnh ước tính kéo dài 20-40 giây "
