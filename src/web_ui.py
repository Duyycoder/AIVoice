...
custom_temp = os.path.join(project_root, "storage", "temp")
...
def generate_speech():
    ...
    config_defaults = {}
    config_path = os.path.abspath(os.path.join(project_root, "configs", "default.json"))
...
try:
    ...
    mc_path = os.path.abspath(os.path.join(apps_dir, "MediaComposer"))
...
if __name__ == '__main__':
    ...
    print("\n" + "="*60)
    print("  You can now view your Flask app in your browser.")
    print(f"  Local URL:   http://localhost:5000")
    print(f"  Network URL: http://{local_ip}:5000")
    print("="*60 + "\n")
    
    # Listen to all interfaces to allow external access
